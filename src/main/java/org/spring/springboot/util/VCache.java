...
public class VCache  {
    final static StringRedisTemplate stringRedisTemplate = SpringUtils.getBean("stringRedisTemplate");
    final static RedisTemplate<String, Object> redisTemplate =SpringUtils.getBean("redisTemplate");
    /**
     * 删除缓存<br>
     * 根据key精确匹配删除
     * @param key
